...
class BFX {
  constructor (apiKey, apiSecret, opts = { version: 1, transform: false }) {
    ...
    if (opts.version === 2) {
      this.rest = new REST2(this.apiKey, this.apiSecret, { transformer: transformer, nonceGenerator: opts.nonceGenerator })
      this.ws = new WS2(this.apiKey, this.apiSecret, { transformer: transformer, nonceGenerator: opts.nonceGenerator })
      opts.autoOpen && this.ws.open()
      return
    }

    this.rest = new REST(this.apiKey, this.apiSecret, opts.nonceGenerator)
